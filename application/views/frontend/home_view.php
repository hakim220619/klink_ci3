                        ...
                        <div class="col-lg-9">
                            <div class="availability-form">
                                <div class="vailability-submit">
                                    <a href="<?php echo site_url('administrator');?>" class="awe-btn awe-btn-13">Klik Disini</a>
                                </div>
                            </div>
                        </div>
                    </div> -->
            ...
            <div class="container">
                ...
                <div class="room-detail_compare">
                    ...
                    <div class="col col-xs-12 col-lg-6 col-lg-offset-3">
                        <div class="ot-heading row-20 mt30 mb30 text-center">
                            <h2 class="shortcode-heading">Kekayaan Intelektual</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <!-- 
                                 ...
                                 -->
                                    <p class="text-justify">Kekayaan Intelektual, disingkat KI adalah hak yang timbul sebagai hasil olah pikir yang menghasilkan suatu produk atau proses yang berguna untuk manusia. Pada intinya KI adalah hak untuk menikmati secara ekonomis dari suatu kreativitas intelektual. Obyek dalam KI adalah karya karya yang timbul atau lahir karena kemampuan intelektual manusia.</p>
                                    <p class="text-justify">Bagi dunia usaha, adanya pelindungan terhadap penyalahgunaan atau pemalsuan karya intelektual yang dimilikinya oleh pihak lain di dalam negeri maupun di luar negeri. Perusahaan yang telah dibangun mendapat citra yang positif dalam persaingan apabila memiliki pelindungan hukum di bidang KI.</p>
                                    </div>
                    ...
                    <a href="<?php echo site_url('about');?>" class="awe-btn awe-btn-default font-hind f12 bold btn-medium mt15">Read More</a>
                </div>
    ...
    <section class="section-deals mt90">
        <div class="container">
            <div class="content">
                <div class="row">
                    ...
                    <h3 class="shortcode-heading"></h3>
                        <div class="ot-heading row-20 mb30 text-center">
                            <h2 class="shortcode-heading">LAYANAN KI DITJEN IKMA</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/merek.jpg'?>" alt="">
                            </div>
                            <div class="info">
                                <a class="title bold f26 font-monserat upper" href="!#">Merek</a>
                                <p class="sub font-monserat f12 f-600 upper mt10 mb20">Layanan</p>
                                <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="<?php echo site_url('fasilities');?>">Read More</a>
                            </div>
                        </div>
                    </div>
                     <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/hakcipta.jpg'?>" alt="">
                            </div>
                            <div class="info">
                                <a class="title bold f26 font-monserat upper" href="!#">Hak Cipta</a>
                                <p class="sub font-monserat f12 f-600 upper mt10 mb20">Layanan</p>
                                <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="<?php echo site_url('fasilities');?>">Read More</a>
                            </div>
                        </div>
                     ...
                     <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/paten.jpg'?>" alt="">
                            </div>
                            <div class="info">
                                <a class="title bold f26 font-monserat upper" href="!#">Paten</a>
                                <p class="sub font-monserat f12 f-600 upper mt10 mb20">Layanan</p>
                                <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="<?php echo site_url('fasilities');?>">Read More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/desainind.jpg'?>" alt="">
                            </div>
                            <div class="info">
                                <a class="title bold f26 font-monserat upper" href="!#">Desain Industri</a>
                                <p class="sub font-monserat f12 f-600 upper mt10 mb20">Layanan</p>
                                <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="<?php echo site_url('fasilities');?>">Read More</a>
                            </div>
                        </div>
                ...
                <div class="text-center">
                    <a href="<?php echo site_url('fasilities');?>" class="awe-btn awe-btn-default font-hind f12 bold btn-medium mt15">View More</a>
                </div>
        </div>
    </section>
    <br><br><br>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-6 col-lg-offset-3">
                        ...
                        <h2 class="shortcode-heading">Latest Article</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-md-4 col-md-pull-8">
                            <div class="sidebar">
                                ...
                                <div class="widget widget_upcoming_events">
                                    <h4 class="widget-title">Kegiatan KI</h4>
                                    <ul>
                                        <?php 
