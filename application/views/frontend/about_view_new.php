                ...
                <div class="room-wrap-2">
                    ...
                    <div class="<?php echo $rata ?>" >
                        ...
                        <div class="text">
                            ...
                            <p align="justify"><?php echo $row->detail;?></p>
                            <a href="<?php echo site_url('tentangki/'.$row->link_detail);?>" class="awe-btn awe-btn-13">Selengkapnya....</a>
                            <hr>
                        </div>
                    </div>
                    <!-- ITEM -->
