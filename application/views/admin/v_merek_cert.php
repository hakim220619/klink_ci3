...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/merek/update_merek_cert'?>" id="form" method="post" enctype="multipart/form-data" class="form-style">
                ...
                <div class="col-md-12 pr-md-5 text-center">
                    <div class="media intro-heading align-self-center">
                        ...
                        <div class="col-md-12 pr-md-5 text-center">
                            ...
                            <a class="btn btn-danger" style="width: 120px;" target="_blank" href="<?php echo base_url().'assets/images/'.$b['merek_cert'];?>">Unduh</a>
                        </div>
                                ...
                                <div class="row form-group" id="merek_cert">
                                 <label class="col-md-12">
                                    <?php if($b['merek_cert'] == "") { ?>
                                        ...
                                        <div class="col-md-12">
                                          <input type="file" name="merek_cert" value="<?php echo $b['merek_cert']; ?>" id="merek_cert" class="btn custom-input-file"><a href="<?php echo base_url().'assets/images/'.$b['merek_cert'];?>"><?php echo $b['merek_cert']; ?></a>
                                        </div>
                                </div>
