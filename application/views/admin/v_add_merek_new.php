...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/merek/simpan_merek'?>"  method="post" enctype="multipart/form-data" class="form-style">
                ...
                <div class="row gutters-tiny invisible" data-toggle="appear"> <!-- div row -->
                    ...
                    <div class="col-md-6 pr-md-5 mt-10">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-note font-12"><i class="fa fa-info-circle"></i> Max-size: 1MB. Format .jpeg/jpg/png (Wajib diisi). klik <a href="<?php echo base_url().'assets/images/'.'cthproduk.pdf' ?>">disini</a> untuk mengunduh contoh foto produk ukuran 640 x 480 pixel)</small>

                            <div class="mt-2">
                            <input type="file" name="merek_photo"  value="<?php echo set_value('merek_photo','0'); ?>"  id="merek_photo" class="btn custom-input-file"><?= form_error('merek_photo','<small pl-3 style="color: red;">','</small>'); ?>   
                        </div>
                    </div>
                   </div>
