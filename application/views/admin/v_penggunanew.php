...
<head>
    ...
    <!-- END Icons -->
    <link rel="stylesheet"
        href="<?php echo base_url() . 'assets/js/plugins/datatables/dataTables.bootstrap4.min.css' ?>">
                        ...
                        <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                            ...
                            <div class="content-header-item">
                                <a href="<?php echo base_url() ?>">
                                    ...
                                    <img src="<?php echo base_url() . 'theme/new/img/logoki03.png' ?>"
                                        style="width: 116px;height: auto;margin-top: -8px;" alt="">
                                </a>
                            </div>
                            <!-- END Logo -->
                        </div>
                    ...
                    <div class="content-side content-side-full content-side-user px-10 align-parent">
                        ...
                        <div class="sidebar-mini-hidden-b text-center">
                            ...
                            <a class="img-link" href="<?php echo base_url() . 'assets/images/user_blank.png' ?>">
                                <img class="img-avatar" src="<?php echo base_url() . 'assets/images/user_blank.png' ?>"
                                    alt="">
                            </a>
                            <?php else : ?>
                    ...
                    <div class="col-md-14">
                        <div class="block">
                            <div class="block-header block-header-default">
                                <h3 class="block-title">Halaman User</h3>
                                <div class="block-options">
                                    <a href="<?php echo site_url('admin/pengguna/export'); ?>"
                                        class="btn btn-outline-success"><span class="fa fa-plus"></span> Exp. to
                                        Excel</a>
                                    <a href="<?php echo site_url('admin/pengguna'); ?>" class="btn btn-primary"
                                        hidden><span class="fa fa-plus"></span> Add New</a>
                                    <button style="margin-bottom: 10px" class="btn btn-primary delete_all"
                                        data-url="<?php echo base_url() . 'admin/pengguna/deleteSlct' ?>">Delete All
                                        Selected</button>

                                </div>
                            </div>
                            <div class="block-content block-content-full">
                                <table id="mytable" class="table table-striped table-responsive table-bordered nowrap"
                                    style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 10px;text-align: center;">IKM/Instansi</th>
                                            <th style="width: 100px;text-align: center;">No. Hp</th>
                                            <th style="width: 30px;text-align: center;">Jenis User</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" class="sub_chk"
                                                    data-id="<?php echo $row->pengguna_id; ?>"></td>
                                            <td style="vertical-align: middle;text-align: center;"><?php echo $no; ?>
                                            </td>
                                            <td style="vertical-align: middle;"><?php echo $row->pengguna_nama; ?></td>
                                            <td style="vertical-align: middle;"><?php echo $row->pengguna_ikm; ?></td>
                                            <td style="vertical-align: middle;"><?php echo $row->pengguna_nohp; ?></td>
                                            <td style="vertical-align: middle;"><?php echo $row->pengguna_jenis; ?></td>
                                            <?php if ($row->pengguna_level == '1') : ?>
                                            <td style="vertical-align: middle;">Administrator</td>
                                            <?php elseif ($row->pengguna_level == '2') : ?>
                                            <td style="vertical-align: middle;">Pembina</td>
                                            <?php else : ?>
                                            <td style="vertical-align: middle;">User</td>
                                            <?php endif; ?>
                                            <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                <a href="<?php echo site_url('admin/pengguna/edit/' . $row->pengguna_id); ?>"
                                                    class="btn btn-outline-primary"><span class="fa fa-edit"></span></a>
                                                <a href="<?php echo site_url('admin/pengguna/delete/' . $row->pengguna_id); ?>"
                                                    class="btn btn-outline-danger"><span class="fa fa-trash"></span></a>


                                                <!-- <a href="<?php echo site_url('admin/pengguna/edit/' . $row->pengguna_id); ?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a> -->
            ...
            <div class="content py-20 font-size-xs clearfix">
                ...
                <div class="float-left">
                    <a class="badge badge-pill badge-danger"
                        href="<?php echo site_url('admin/dashboard'); ?>">Dashboard</a> &copy; <span
