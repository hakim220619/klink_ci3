...
<body>
    ...
    <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
        ...
        <main id="main-container">
            <!-- Page Content -->
            <div class="content">
                <form action="<?php echo base_url() . 'admin/dashboard/update_kegiatan' ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="block">
                                ...
                                <div class="block-content">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="title" value="<?php echo $b['title']; ?>" class="form-control" placeholder="Masukan Title" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="deskripsi" value="<?php echo $b['deskripsi']; ?>" class="form-control" placeholder="Masukan deskripsi" required>
                                    </div>
                                    <div class="form-group">
                                        <textarea name="content" id="ckeditor" required><?php echo $b['content']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <div class="form-group">
                                        <input type="file" name="filefoto" class="dropify2" data-height="230" data-default-file="<?php echo base_url() . 'assets/images/' . $b['image']; ?>">
                                    </div>


                                </div>
                                <div class="block-content block-content-full block-content-md bg-body-light">
                                    <input type="hidden" name="kode" value="<?php echo $b['id']; ?>" required>
