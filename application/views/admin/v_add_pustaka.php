...
<!-- font awesome -->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/pustaka/simpan'?>" id="formhc5" method="post" enctype="multipart/form-data" class="form-style">
                ...
                <div class="row"> <!-- div row -->
                    ...
                    <div class="col-md-6 pr-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="namafile"  value="<?= set_value('namafile') ?>" class="form-control"><?= form_error('namafile','<small pl-3 style="color: red;">','</small>'); ?>
                        </div>

                       
                          <div class="form-group">
                            <label class="control-label">Kategori:</label><br>
                             <select name="xjta" value="<?= set_value('xjta')== '$kategoripus_id;' ?>" id="xjta" class="form-control">
                            <option value="" disabled selected hidden>------------------------------- Kategori -------------------------------</option>
                              <?php 
                              foreach ($kat->result_array() as $k) :
                              $kategoripus_id=$k['kategoripus_id'];
                              $kategoripus_nama=$k['kategoripus_nama'];
                              ?>
                            <option value="<?php echo $kategoripus_id;?>"><?php echo $kategoripus_nama;?></option>
                             <?php endforeach; ?>
                              
                            </select> 
                              <?= form_error('xjta','<small pl-3 style="color: red;">','</small>'); ?>                     
                      </div>
                      ...
                      <div class="form-group">
                            ...
                            <textarea name="ket" id="ket" class="form-control" rows="4" maxlength="300"></textarea>
                            <?= form_error('ket','<small pl-3 style="color: red;">','</small>'); ?>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-3">
                            <button type="submit" class="btn btn-primary btn-sm" style="width: 70px;">SIMPAN</button>
                            <input type="hidden" name="kode" value="<?php echo $b['pu_id']; ?>" required>
