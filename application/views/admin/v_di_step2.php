...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/desainind/update_di2'?>" id="form" method="post" enctype="multipart/form-data" class="form-style">
...
<a href="<?php echo base_url()."admin/desainind/viewdi2/".$b['di_id'];?>" class="badge badge-primary badge-sm pull-right" style="width: 40px;margin-left: 2px !important;"> 2 </a>
            ...
            <div class="card-body"> <!-- div card-body -->
                <div class="row gutters-tiny invisible" data-toggle="appear"> <!-- div row -->
                    ...
                    <div class="col-md-6 pr-md-5">
                        <div class="form-group">
                            ...
                            <input type="text" name="di_nama" id="di_nama" value="<?php echo $b['di_nama']; ?>" class="form-control" required>
                        </div>
                        ...
                        <div class="form-group">
                                        ...
                                        <div>
                                            <div class="custom-control custom-radio"><!-- custom-control-inline -->
                                                <input class="custom-control-input" type="radio" name="typeusaha" id="iumk1" required value="IUMK" <?php echo $b['di_ketusaha'] == 'IUMK' ? "checked" : ""; ?>>
                                        ...
                                        <div>
                                            <div class="custom-control custom-radio"><!-- custom-control-inline -->
                                                <input class="custom-control-input" type="radio" name="typeusaha" id="nib1"  value="NIB" <?php echo $b['di_ketusaha'] == 'NIB' ? "checked" : ""; ?>>
                                        ...
                                        <div>
                                            <div class="custom-control custom-radio"><!-- custom-control-inline -->
                                                <input class="custom-control-input" type="radio" name="typeusaha" id="tdi1" value="TDI" <?php echo $b['di_ketusaha'] == 'TDI' ? "checked" : ""; ?>>
                                        ...
                                        <div>
                                            <div class="custom-control custom-radio">
                                                <input class="custom-control-input" type="radio" name="typeusaha" id="iui1" value="IUI" <?php echo $b['di_ketusaha'] == 'IUI' ? "checked" : ""; ?>>
                                        ...
                                        <div>
                                            <div class="custom-control custom-radio">
                                                <input class="custom-control-input" type="radio" name="typeusaha" id="siup1" value="SIUP" <?php echo $b['di_ketusaha'] == 'SIUP' ? "checked" : ""; ?>>
                                        ...
                                        <div>
                                            <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" name="typeusaha" id="kop1" value="KOPERASI" <?php echo $b['di_ketusaha'] == 'KOPERASI' ? "checked" : ""; ?>>
                                                <label class="custom-control-label" for="kop1">Koperasi</label>
                                            </div>
                                       </div> 
                                       <div>
                                            <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" name="typeusaha" id="lainnya1" value="BENTUK KETERANGAN USAHA LAINNYA" <?php echo $b['di_ketusaha'] == 'BENTUK KETERANGAN USAHA LAINNYA' ? "checked" : ""; ?>>
                    ...
                    <div class="form-group">
                            ...
                            <div class="mt-2">
                                <div class="row form-group" id="di_fileketusaha">
                                 <label class="col-md-12">
                                       
                                        </label>
                                        <div class="col-md-12">
                                        <?php if($b['di_fileketusaha'] == "") { ?>
                                        <input type="file" name="di_fileketusaha" value="<?php echo $b['di_fileketusaha']; ?>" id="di_fileketusaha" class="btn custom-input-file" required>
                                        <?php } else { ?>
                                        <input type="file" name="di_fileketusaha" value="<?php echo $b['di_fileketusaha']; ?>" id="di_fileketusaha" class="btn custom-input-file">
                                        <?php } ?>
                                        <a href="<?php echo base_url().'assets/images/'.$b['di_fileketusaha'];?>"><?php echo $b['di_fileketusaha']; ?></a>
                                        </div>
                                </div>
                        ...
                        <!-- <div class="form-group">
                            <label class="control-label">Kewarganegaraan:</label>
                                <input type="text" name="di_warganegara" id="hc_warganegara" value="<?php echo $b['hc_warganegara']; ?>" class="form-control">
                        </div>
                        -->
                    ...
                    <div class="col-md-6 pr-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="di_alamat" id="di_alamat" class="form-control" rows="4" maxlength="300" required oninvalid="this.setCustomValidity('Wajib Diisi')" oninput="setCustomValidity('')"><?php echo $b['di_alamat']; ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label">Kode Pos:</label>
                                <input type="text" name="di_kodepos" id="di_kodepos" value="<?php echo $b['di_kodepos']; ?>" class="form-control">
                        </div>
                ...
                <div class="row">
                        <div class="col-md-12 mt-3">
                            ...
                            <a href="<?php echo base_url()."admin/desainind/viewdi1/".$b['di_id'];?>" class="btn btn-danger btn-sm pull-right" style="width: 70px;">Kembali</a>
                        </div>
                </div>
