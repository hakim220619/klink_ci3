...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Merek</h3>
                                    <div class="block-options">
                                        <?php if($this->session->userdata('akses')=='1'):?>
                                        <a href="<?php echo site_url('admin/merek/export');?>" class="btn btn-success"><span class="fa fa-plus"></span> Exp. to Excel</a>
                                        <?php else:?>
                                        <a href="<?php echo site_url('admin/merek/export');?>" class="btn btn-success" hidden><span class="fa fa-plus" hidden></span> Exp. to Excel</a>
                                        <?php endif;?>  
                                        <a href="<?php echo site_url('admin/merek/add_new');?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                    </div>
                                </div>
                                    ...
                                    <table id="mytable" class="table table-striped table-responsive table-bordered nowrap" style="width:100%">
                                        <thead>
                                            <th style="width: 30px;text-align: center;">No</th>
                                                ...
                                                <th style="width: 230px;text-align: center;">Nama Pemohon</th>
                                                <th style="width: 27px;text-align: center;">Email</th>
                                                <th style="width: 30px;text-align: center;">Tgl Daftar</th>
                                                <th style="width: 27px;text-align: center;">Hari</th>                                                
                                                <th style="width: 27px;text-align: center;">Status</th>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center"><img style="width:50px;height:40px;" src="<?php echo base_url().'assets/images/'.$row->merek_photo;?>"></td>
                                                <td style="vertical-align: middle;text-transform: lowercase;"><?php echo $row->merek_nama;?></td>
                                                <td style="vertical-align: middle;text-transform: lowercase;"><?php echo $row->merek_email;?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->merek_register;?></td>
                                                <td style="vertical-align: middle;text-align: center;"><?php echo $row->hari;?></td>
                                              <?php if($row->idstatus == 1):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/merek/viewmerek1/'.$row->merek_id);?>" class="btn btn-warning btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php elseif($row->idstatus == 2):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/merek/view/'.$row->merek_id);?>" class="btn btn-primary btn-block" disabled><?php echo $row->namastatus;?></td></a>
                                               <?php elseif($row->idstatus == 3):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/merek/view/'.$row->merek_id);?>" class="btn btn-secondary btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php elseif($row->idstatus == 4):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/merek/view/'.$row->merek_id);?>" class="btn btn-success btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php elseif($row->idstatus == 5):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/merek/viewcert/'.$row->merek_id);?>" class="btn btn-danger btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php elseif($row->idstatus == 6):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/merek/viewcert_cancel/'.$row->merek_id);?>" class="btn btn-info btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php else:?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/merek/view/'.$row->merek_id);?>" class="btn btn-secondary btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php endif;?>
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
						                          <!-- <?php if($this->session->userdata('akses')=='1'):?>
                                                    <a href="<?php echo site_url('admin/merek/edit/'.$row->merek_id);?>" class="btn btn-sm btn-secondary2 btn-circle"><span class="fa fa-eye"></span></a>
                                                    <?php endif;?> -->
                                                    <a href="<?php echo site_url('admin/merek/view/'.$row->merek_id);?>"><span class="fa fa-pencil">
                                                    <?php if($this->session->userdata('akses')=='1' && $row->idstatus == 4 && $row->hari > 296):?><span class="badge badge-primary" style="font-family: system-ui; text-decoration: blink; width: 45px;margin-left: 4px !important;"><span class="blink" style="font-family: system-ui;font-size: 10.5px;">Limit</span></span>
                                                    <?php else:?>
                                                    ...
                                                    <?php endif;?></a>  
                                                    <!-- <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->merek_id;?>"><span class="fa fa-trash"></span></a> -->
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                        </tbody>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/merek/hapus_merek'?>" method="post">
    ...
    <?php elseif($this->session->flashdata('msg')=='gagal-view-proses'):?>
        ...
        <?php elseif($this->session->flashdata('msg')=='bates-input'):?>
            <script type="text/javascript">
                    $.toast({
                        heading: 'Warning',
                        text: "Kuota permohonan Merek anda sudah habis.",
                        showHideTransition: 'slide',
                        icon: 'success',
                        hideAfter: 4000,
                        position: 'bottom-right',
