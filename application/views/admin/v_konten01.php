...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Konten 01</h3>
                                    <div class="block-options">
                                        <a href="<?php echo site_url('admin/konten01/add_new');?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                    </div>
                                </div>
                                <div class="block-content block-content-full">
                                    <table id="mytable" class="table table-striped table-responsive">
                                        ...
                                        <?php 
                                            $no=0;
                                            foreach ($konten01->result() as $row) :
                                            $no++;
                                        ?>
                                            <tr>
                                                ...
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/konten01/edit/'.$row->kd_konten01);?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->kd_konten01;?>"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                        </tbody>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/konten01/hapus_konten01'?>" method="post">
