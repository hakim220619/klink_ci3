...
<html lang="en" class="no-focus">
    ...
    <body>
                        ...
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    ...
                                    <h1 class="h3 font-w700 mt-30 mb-10">Reset Kata Sandi.</h1>
                                    <h2 class="h5 font-w400 text-muted mb-0">Masukkan Kata Sandi</h2>
                                </div>
                                <!-- END Header -->

                                <form class="js-validation-signin px-30" action="<?php echo base_url().'administrator/changePassword'?>" method="post">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <br/><?= form_error('password2','<small pl-3 style="color: red;">','</small>'); ?>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-sm  btn-alt-primary btn-block">
                                            <i class="si si-login mr-20"></i>Ganti Kata Sandi                               </button>
                                        <!-- <a href="<?php echo base_url().'administrator'?>" class="btn btn-sm  btn-alt-primary btn-block">
                                            <i class="si si-login mr-20"></i>Daftar
                                        </a> -->
                                        <div class="text-center">
                                        <a class="small text-primary" href="<?php echo base_url().'administrator'?>">>>Login<<</a>
                                        </div>
                                        <div class="text-center">
                                        <a class="small text-primary" href="<?= base_url('administrator/registration'); ?>">>>Daftar?<<</a>
                                        </div>
                                    </div>
        ...
        <?php elseif($this->session->flashdata('msg')=='salah-password'):?>
            <script type="text/javascript">
                    $.toast({
                        heading: 'Warning',
