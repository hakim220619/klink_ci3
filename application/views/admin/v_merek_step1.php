...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <!-- <?php if ($vmerek->merek_statusid == 2) {
 ...
 -->
            ...
            <form action="<?php echo base_url().'admin/merek/update_merek1'?>" id="form" method="post" enctype="multipart/form-data" class="form-style">
...
<a href="<?php echo base_url()."admin/merek/viewmerek1/".$b['merek_id'];?>" class="badge badge-primary badge-sm pull-right" style="width: 40px;margin-left: 2px !important;"> 1 </a>
                ...
                <div class="row gutters-tiny invisible" data-toggle="appear"> <!-- div row -->
                    ...
                    <div class="col-md-6 pr-md-5 mt-10">
                        <div class="form-group">
                            ...
                            <input type="text" name="merek_email" value="<?php echo $b['merek_email'];?>" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Tanggal Pengajuan:</label>
                            <input type="text" name="tglaju" id="tglaju" value="<?php echo $b['merek_tgl_pengajuan']; ?>" class="form-control" readonly>
                        </div>

                       <!-- <div class="form-group">
                            <?php if($this->session->userdata('akses')=='1'):?>
                            <label class="control-label">Tanggal Penerimaan</label>
                            <input type="text" name="merek_tgl_penerimaan" id="merek_tgl_penerimaan" class="form-control" value="<?php if($b['merek_tgl_penerimaan'] == "0000-00-00") { } else { echo $b['merek_tgl_penerimaan']; }; ?>" data-date-format="yyyy-mm-dd" autocomplete="off">
                            <?php else:?>
                                <label class="control-label">Tanggal Penerimaan</label>
                            <input type="text" name="merek_tgl_penerimaan" id="vmerek_tgl_penerimaan" class="form-control" value="<?php if($b['merek_tgl_penerimaan'] == "0000-00-00") { } else { echo $b['merek_tgl_penerimaan']; }; ?>" data-date-format="yyyy-mm-dd" autocomplete="off" readonly>
                            <?php endif;?>
                        </div> -->
                        ...
                        <div class="form-group">
                           ...
                           <?php if($this->session->userdata('akses')=='1'):?>
                            <input type="text" name="merek_no_permohonan" id="merek_no_permohonan" value="<?php echo $b['merek_no_permohonan']; ?>" class="form-control">
			    <small class="text-note"><i class="fa fa-info-circle"></i> Diisi oleh petugas.</small>
                            <?php else:?>
                            <input type="text" name="merek_no_permohonan" id="merek_no_permohonan" value="<?php echo $b['merek_no_permohonan']; ?>" class="form-control" readonly>
			    <small class="text-note"><i class="fa fa-info-circle"></i> Diisi oleh petugas.</small>
                            <?php endif;?>
                        </div>
                    ...
                    <div class="col-md-6 pr-md-5 mt-10">
                        <div class="form-group">
                            ...
                            <input type="text" name="merek_nama" value="<?php echo $b['merek_nama'];?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label">Unggah Foto Produk</label><br>
                            <small class="text-note font-12"><i class="fa fa-info-circle"></i> Max-size: 1MB. Format .jpeg/jpg/png (Wajib diisi).</small>

                            <div class="mt-2">
                                <div class="row form-group" id="merek_photo">
                                 <label class="col-md-12">
                                    <?php if($b['merek_photo'] == "") { ?>
                                        ...
                                        <div class="col-md-12">
                                          <input type="file" name="merek_photo" value="<?php echo $b['merek_photo']; ?>" id="merek_photo" class="btn custom-input-file"><a href="<?php echo base_url().'assets/images/'.$b['merek_photo'];?>"><?php echo $b['merek_photo']; ?></a>
                                        </div>
                                </div>
