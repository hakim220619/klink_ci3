...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Penolakan Hakcipta</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/hakcipta/update_hc_cert_cancel'?>" id="form" method="post" enctype="multipart/form-data" class="form-style">
                ...
                <div class="col-md-12 pr-md-5 text-center">
                    <div class="media intro-heading align-self-center">
                        ...
                        <div class="col-md-12 pr-md-5 text-center">
                            ...
                            <a class="btn btn-danger" style="width: 120px;" target="_blank" href="<?php echo base_url().'assets/images/'.$b['hc_cert_cancel'];?>">Unduh</a>
                        </div>
                                ...
                                <div class="row form-group" id="hc_cert_cancel">
                                 <label class="col-md-12">
                                    <?php if($b['hc_cert_cancel'] == "") { ?>
                                        ...
                                        <div class="col-md-12">
                                          <input type="file" name="hc_cert_cancel" value="<?php echo $b['hc_cert_cancel']; ?>" id="hc_cert_cancel" class="btn custom-input-file"><a href="<?php echo base_url().'assets/images/'.$b['hc_cert_cancel'];?>"><?php echo $b['hc_cert_cancel']; ?></a>
                                        </div>
                                </div>
