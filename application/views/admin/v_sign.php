	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" id="form" action="<?php echo base_url().'administrator/auth'?>" method="post">
					...
					<div class="text-center p-t-12">
						...
						<a class="txt2" href="<?= base_url('administrator/forgotPassword'); ?>">
							Pengguna / Kata Sandi?
						</a>
					</div>
					<div class="text-center p-t-12">
						<a class="txt2" href="<?php echo base_url().'administrator/registration'?>">
