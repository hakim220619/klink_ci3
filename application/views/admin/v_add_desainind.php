    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                <form action="<?php echo base_url().'admin/desainind/simpan_desainind'?>" id="form" method="post" enctype="multipart/form-data">
        ...
        $('#email').change(function() {
            ...
            if(email != '') {
                $.ajax({
                    url: "<?php echo base_url('admin/desainind/cek_email'); ?>",
                    method : "post",
                    data   : { email:email },
