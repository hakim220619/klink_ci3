...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Penolakan Desain Ind</title>

        desaindindme="description" content="">
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/desainind/update_di_cert_cancel'?>" id="form" method="post" enctype="multipart/form-data" class="form-style">
                ...
                <div class="col-md-12 pr-md-5 text-center">
                    <div class="media intro-heading align-self-center">
                        ...
                        <div class="col-md-12 pr-md-5 text-center">
                            ...
                            <!-- <a href="<?php echo base_url()."admin/desaindind/view/".$b['di_id'];?>" class="btn btn-danger btn-sm" style="width: 70px;">Kembali</a> -->
                            <a class="btn btn-danger" style="width: 120px;" target="_blank" href="<?php echo base_url().'assets/images/'.$b['di_cert_cancel'];?>">Unduh</a>
                        </div>
                                ...
                                <div class="row form-group" id="di_cert_cancel">
                                 <label class="col-md-12">
                                    <?php if($b['di_cert_cancel'] == "") { ?>
                                        ...
                                        <div class="col-md-12">
                                          <input type="file" name="di_cert_cancel" value="<?php echo $b['di_cert_cancel']; ?>" id="di_cert_cancel" class="btn custom-input-file"><a href="<?php echo base_url().'assets/images/'.$b['di_cert_cancel'];?>"><?php echo $b['di_cert_cancel']; ?></a>
                                        </div>
                                </div>
