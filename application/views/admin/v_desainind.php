...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Desain Industri</h3>
                                    <div class="block-options">
                                        <?php if($this->session->userdata('akses')=='1'):?>
                                        <a href="<?php echo site_url('admin/desainind/export');?>" class="btn btn-success"><span class="fa fa-plus"></span> Exp. to Excel</a>
                                        <?php else:?>
                                        <a href="<?php echo site_url('admin/desainind/export');?>" class="btn btn-success" hidden><span class="fa fa-plus" hidden></span> Exp. to Excel</a>
                                        <?php endif;?>                                           
                                        <a href="<?php echo site_url('admin/desainind/add_new');?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                    </div>
                                </div>
                                <div class="block-content block-content-full">
                                    <table id="mytable" class="table table-striped table-responsive table-bordered nowrap" style="width:100%">
                                        ...
                                        <?php 
                                            $no=0;
                                            foreach ($desainind->result() as $row) :
                                            $no++;
                                        ?>
                                            <tr>
                                                <td style="vertical-align: middle;text-align: center;"><?php echo $no;?></td>
                                                <td align="center"><img style="width:50px;height:40px;" src="<?php echo base_url().'assets/images/'.$row->di_photo;?>"></td>
                                                <td style="vertical-align: middle;text-transform: lowercase"><?php echo $row->di_nama;?></td>
                                                <td style="vertical-align: middle;text-transform: lowercase;"><?php echo $row->di_email;?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->di_nohp;?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->di_register;?></td>
                                              <?php if($row->idstatus == 1):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/desainind/viewdi1/'.$row->di_id);?>" class="btn btn-warning btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php elseif($row->idstatus == 2):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/desainind/view/'.$row->di_id);?>" class="btn btn-primary btn-block"><?php echo $row->namastatus;?></td></a>
                                               <?php elseif($row->idstatus == 3):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/desainind/view/'.$row->di_id);?>" class="btn btn-secondary btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php elseif($row->idstatus == 4):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/desainind/view/'.$row->di_id);?>" class="btn btn-success btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php elseif($row->idstatus == 5):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/desainind/viewdicert/'.$row->di_id);?>" class="btn btn-danger btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php elseif($row->idstatus == 6):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/desainind/viewdicert_cancel/'.$row->di_id);?>" class="btn btn-info btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php else:?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/desainind/view/'.$row->di_id);?>" class="btn btn-secondary btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php endif;?>
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/desainind/view/'.$row->di_id);?>"><span class="fa fa-pencil">
                                                    ...
                                                    <?php endif;?></a>  
                                                    <!-- <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->di_id;?>"><span class="fa fa-trash"></span></a> -->
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                        </tbody>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/desainind/hapus_desainind'?>" method="post">
        ...
        <?php elseif($this->session->flashdata('msg')=='bates-input'):?>
            <script type="text/javascript">
                    $.toast({
                        heading: 'Warning',
                        text: "Kuota permohonan Desain Industri anda sudah habis.",
                        showHideTransition: 'slide',
                        icon: 'success',
                        hideAfter: 4000,
                        position: 'bottom-right',
