    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                <form action="<?php echo base_url().'admin/paten/simpan_paten'?>" id="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-8">
                            <div class="block">
                              ...
                              <div class="block-content">
                                    ...
                                    <div class="form-group">
                                            <input type="text" name="ikm" id="ikm" class="form-control" placeholder="Nama Perusahaan/IKM" autocomplete="off" required>
                                    </div>
                                    <div class="form-group">
                                            <input type="email" name="email" id="email" class="form-control" placeholder="Email contoh: example@mail.com" required>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Alamat:</label>
                                            <textarea name="alamat" id="alamat" class="form-control" rows="4" maxlength="300" required oninvalid="this.setCustomValidity('Wajib Diisi')" oninput="setCustomValidity('')"><?php echo $b['pt_alamat']; ?></textarea>
                                            <div><span id="alamat"></span></div>
                                    </div>
                                    <div class="form-group">
