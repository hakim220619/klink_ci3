    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                <form action="<?php echo base_url().'admin/merek/simpan_merek'?>" method="post" enctype="multipart/form-data">
                    <div class="row gutters-tiny invisible" data-toggle="appear">
                        <div class="col-md-8">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">IDENTITAS IKM</h3>
                                </div>
                                <div class="block-content">
                                    
                                    <div class="form-group">
                                            <input type="text" name="nama"  value="<?php echo set_value('nama'); ?>" class="form-control" placeholder="Nama Pemilik IKM" autocomplete="off" required>
                                    </div>
                                    <div class="form-group">
                                            <input type="email" name="email" id="email" class="form-control" placeholder="Alamat Email contoh: example@mail.com" required>
                                            <div><span id="cek_email_feedback"></span></div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="tel" name="no_telp" id="no_telp" class="form-control" placeholder="Nomor Whatsapp Gunakan Awalan 62 contoh: 6287782728299" autocomplete="off" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    ...
                                    <div class="block-content">
                                        <small class="text-note"><i class="fa fa-info-circle"></i> (Max-size: 1MB. Format .jpeg/jpg/png dan klik <a href="<?php echo base_url().'assets/images/'.'cthproduk.pdf' ?>">disini</a> untuk mengunduh contoh foto produk ukuran 640 x 480 pixel)</small>
                                        <div class="form-group">
        ...
        <script type="text/javascript">
            ...
            messages: {
                ...
                filefoto: {
                    required: "file foto harus diisi.",
                },
            },
        ...
        //     if(email != '') {
        //         $.ajax({
        //             url: "<?php echo base_url('admin/merek/cek_email'); ?>",
        //             method : "post",
        //             data   : { email:email },
