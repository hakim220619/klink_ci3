...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Pustaka</h3>
                                    <div class="block-options">
                                                                            
                                        <a href="<?php echo site_url('admin/pustaka/add_new');?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                    </div>
                                </div>
                                    ...
                                    <table id="mytable" class="table table-striped table-responsive table-bordered nowrap" style="width:100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;vertical-align: middle;"><?php echo $row->namastatus;?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->pu_keterangan;?></td>
                                                <td style="width: 30px;text-align: center;vertical-align: middle;"><a href="<?php echo base_url().'assets/images/user/'.$row->pu_link;?>" class="btn btn-sm btn-warning">Download</a></td>
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/pustaka/edit/'.$row->pu_id);?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->pu_id;?>"><span class="fa fa-trash"></span></a>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/pustaka/hapus_pustaka'?>" method="post">
