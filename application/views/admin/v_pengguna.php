                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php elseif($pengguna_level=='2'):?>
                                                    <td style="vertical-align: middle;">Pengusul</td>
												<?php else:?>
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">
                              <select name="xlevel" id="xlevel" class="form-control opt1hid" required>
                                     <option value="" disabled selected hidden>Level User</option>
                                      <?php $role = $this->db->query("SELECT * FROM role ORDER BY role_nama ASC")->result(); ?>
                                        <?php foreach ($roles as $rl) { ?>
                                        <?php if($b['pengguna_level'] == 0) { ?>
                                            <option value="<?php echo $rl->role_id; ?>"><?php echo $rl->role_nama; ?></option>
                                        <?php } else { ?>
                                            <option value="<?php echo $rl->role_id; ?>" <?php echo ($rl->role_id == $b['pengguna_level']) ? "selected" : ""; ?>>
                                                <?php echo $rl->role_nama; ?>
                                            </option>
                                        <?php }; ?>
                                      <?php }; ?>
                                     </select>
