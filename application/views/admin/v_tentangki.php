...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Tentang KI</h3>
                                    <div class="block-options">
                                        <a href="<?php echo site_url('admin/tentangki/add_new');?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                    </div>
                                </div>
                                <div class="block-content block-content-full">
                                    <table id="mytable" class="table table-striped table-responsive">
                                        ...
                                        <?php 
                                            $no=0;
                                            foreach ($tentangki->result() as $row) :
                                            $no++;
                                        ?>
                                            <tr>
                                                ...
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/tentangki/edit/'.$row->kd_tentangki);?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->kd_tentangki;?>"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                        </tbody>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    ...
                    <div class="float-left">
                        <a class="font-w600" href="https://klinikki.kemenperin.go.id" target="_blank">KLINIK KI</a> &copy; <span class="js-year-copy"><?php echo date('Y');?></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/tentangki/hapus_tentangki'?>" method="post">
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <p>Anda yakin mau menghapus tentangki dan service ini?</p>
