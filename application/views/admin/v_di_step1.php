...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/desainind/update_di1'?>" method="post" enctype="multipart/form-data" class="form-style">

<!----------------------------------------- FORM SECTION 1 ------------------------------------------->

              <div class="block-header block-header-default">
                 <h2 class="block-title" style="text-align:center;">FORMULIR PENDAFTARAN DESAIN INDUSTRI</h2>
                ...
                <div class="col-md-6 pr-md-5 text-center">
                    <div class="media intro-heading align-self-center">
                        <div class="media-body align-self-center">
                            <h3 class="font-weight-bold">Selamat Datang</h3><h4>Hi, <?php echo $b['di_nama'];?></h4>
                            <a class="img-link" href="#">
                                 <img  style="width:150px;height:150px;" src="<?php echo base_url().'assets/images/'.$b['di_photo'];?>" alt="">
                            </a> 
                    ...
                    <div class="col-md-6 pr-md-5 mt-10">
                        <div class="form-group">
                            ...
                            <input type="text" name="di_tgl_pengajuan" id="di_tgl_pengajuan" value="<?php echo $b['di_tgl_pengajuan']; ?>" class="form-control" readonly>
                        </div>

                        <!-- <div class="form-group">
                            <?php if($this->session->userdata('akses')=='1'):?>
                            <label class="control-label">Tanggal Penerimaan</label>
                            <input type="text" name="di_tgl_penerimaan" id="di_tgl_penerimaan" class="form-control" value="<?php if($b['di_tgl_penerimaan'] == "0000-00-00") { } else { echo $b['di_tgl_penerimaan']; }; ?>" data-date-format="yyyy-mm-dd" autocomplete="off">
                            <?php else:?>
                                <label class="control-label">Tanggal Penerimaan</label>
                            <input type="text" name="di_tgl_penerimaan" id="vdi_tgl_penerimaan" class="form-control" value="<?php if($b['di_tgl_penerimaan'] == "0000-00-00") { } else { echo $b['di_tgl_penerimaan']; }; ?>" data-date-format="yyyy-mm-dd" autocomplete="off" readonly>
                            <?php endif;?>
                        </div> -->
