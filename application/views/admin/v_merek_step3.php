...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/merek/update_merek3'?>" method="post" enctype="multipart/form-data" class="form-style">
                ...
                <div class="row"> <!-- div row -->
                    ...
                    <div class="col-md-6 pr-md-5">
                        ...
                        <div class="form-group">
                            <label class="control-label">Nama Kuasa:</label>
                                <input type="text" name="namakuasa" id="namakuasa" value="<?php echo $b['merek_namakuasa']; ?>" class="form-control">
                        </div>

                        <div class="form-group">
                            <label class="control-label">No. Konsultan:</label>
                                <input type="text" name="nokonsul" id="nokonsul" value="<?php echo $b['merek_nokonsultan']; ?>" class="form-control">
                        </div>

                        <div class="form-group">
                            <label class="control-label">Nama Kantor:</label>
                                <input type="text" name="namakantor" id="namakantor" value="<?php echo $b['merek_namakantor']; ?>" class="form-control">
                        </div>
                    ...
                    <div class="col-md-6 pr-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alamatkonsul" id="alamatkonsul" class="form-control" rows="4" maxlength="300"><?php echo $b['merek_alamatkuasa']; ?></textarea>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Telepon:</label>
                                <input type="text" name="tlpkuasa" id="tlpkuasa" value="<?php echo $b['merek_teleponkuasa']; ?>" class="form-control">
                        </div>

                        <div class="form-group">
                            <label class="control-label">Fax:</label>
                                <input type="text" name="faxkuasa" id="faxkuasa" value="<?php echo $b['merek_faxkuasa']; ?>" class="form-control">
                        </div>
                 ...
                 <div class="row">
                        <div class="col-md-12 mt-3">
                            ...
                            <a href="<?php echo base_url()."admin/merek/viewmerek2/".$b['merek_id'];?>" class="btn btn-danger">Kembali</a>
