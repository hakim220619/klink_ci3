...
<body>
                        ...
                        <div class="block">
                            <div class="block-header block-header-default">
                                ...
                                <div class="block-options">
                                    <a href="<?php echo site_url('admin/dashboard/add_kegiatan'); ?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><img width="80px;" src="<?php echo base_url() . 'assets/images/' . $row->image; ?>"></td>
                                                ...
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/dashboard/edit_kegiatan/' . $row->id); ?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->id; ?>"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
    ...
    <!-- Modal Hapus -->
    <form action="<?php echo base_url() . 'admin/dashboard/hapus_kegiatan' ?>" method="post">
