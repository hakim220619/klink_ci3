...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Desain Industri - Sertifikat</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/desainind/update_di_cert'?>" id="form" method="post" enctype="multipart/form-data" class="form-style">

<!----------------------------------------- FORM SECTION 1 ------------------------------------------->

              <div class="block-header block-header-default">
                 <h2 class="block-title" style="text-align:center;"><b>UNDUH SERTIFIKAT HAK CIPTA</b></h2>
                ...
                <div class="col-md-12 pr-md-5 text-center">
                    <div class="media intro-heading align-self-center">
                        <div class="media-body align-self-center">
                            <!-- <h3 class="font-weight-bold">Selamat Datang</h3><h4>Hi, <?php echo $b['di_nama'];
                            ?></h4> -->
                            <a class="img-link" href="#">
                        ...
                        <div class="col-md-12 pr-md-5 text-center">
                            ...
                            <a class="btn btn-danger" style="width: 120px;" target="_blank" href="<?php echo base_url().'assets/images/'.$b['di_cert'];?>">Unduh</a>
                        </div>
...
<div>
              <div class="block-header block-header-default">
                 <h2 class="block-title" style="text-align:center;"><b>UNGGAH SERTIFIKAT DESAIN INDUSTRI</b></h2>
                 <!-- <h2 class="block-title" style="text-align:right;"><b>(Form Isian 1 - 3)</b></h2> -->
              </div>
...
<div hidden>
              <div class="block-header block-header-default">
                 <h2 class="block-title" style="text-align:center;"><b>UNGGAH SERTIFIKAT desainind</b></h2>
                 <!-- <h2 class="block-title" style="text-align:right;"><b>(Form Isian 1 - 3)</b></h2> -->
              </div>
                ...
                <div class="col-md-12 text-center">
                                ...
                                <div class="row form-group" id="di_cert">
                                 <label class="col-md-12">
                                    <?php if($b['di_cert'] == "") { ?>
                                        ...
                                        <div class="col-md-12">
                                          <input type="file" name="di_cert" value="<?php echo $b['di_cert']; ?>" id="di_cert" class="btn custom-input-file"><a href="<?php echo base_url().'assets/images/'.$b['di_cert'];?>"><?php echo $b['di_cert']; ?></a>
                                        </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 pr-md-5 text-center">
                             <input type="hidden" name="kode" value="<?php echo $b['di_id']; ?>" required>
                            <!-- <a href="<?php echo base_url()."admin/desainind/view/".$b['di_id'];?>" class="btn btn-danger btn-sm" style="width: 70px;">Kembali</a> -->
                            <a class="btn btn-danger" target="_blank" href="<?php echo base_url().'assets/images/'.$b['di_photo'];?>">Upload</a>
