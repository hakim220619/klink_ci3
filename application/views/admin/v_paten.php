...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Paten</h3>
                                    <div class="block-options">
                                        <?php if($this->session->userdata('akses')=='1'):?>
                                        <a href="<?php echo site_url('admin/paten/export');?>" class="btn btn-success"><span class="fa fa-plus"></span> Exp. to Excel</a>
                                        <?php else:?>
                                        <a href="<?php echo site_url('admin/paten/export');?>" class="btn btn-success" hidden><span class="fa fa-plus" hidden></span> Exp. to Excel</a>
                                        <?php endif;?>                                           
                                        <a href="<?php echo site_url('admin/paten/add_new');?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                    </div>
                                </div>
                                    ...
                                    <table id="mytable" class="table table-striped table-responsive table-bordered nowrap" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 230px;text-align: center;">Nama</th>
                                                <th style="width: 130px;text-align: center;">Email</th>
                                                <th style="width: 30px;text-align: center;">No. Hp</th>
                                                <th style="width: 30px;text-align: center;">Tanggal</th>
                                        ...
                                        <?php 
                                            $no=0;
                                            foreach ($paten->result() as $row) :
                                            $no++;
                                        ?>
                                            <tr>
                                                <td style="vertical-align: middle;text-align: center;"><?php echo $no;?></td>
                                                <td align="center"><img style="width:50px;height:40px;" src="<?php echo base_url().'assets/images/'.$row->pt_photo;?>"></td>
                                                <td style="vertical-align: middle;"><?php echo $row->pt_nama;?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->pt_email;?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->pt_nohp;?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->pt_register;?></td>
                                              <?php if($row->idstatus == 1):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/paten/edit/'.$row->pt_id);?>" class="btn btn-warning btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php elseif($row->idstatus == 2):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/paten/edit/'.$row->pt_id);?>" class="btn btn-primary btn-block"><?php echo $row->namastatus;?></td></a>
                                               <?php elseif($row->idstatus == 3):?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/paten/edit/'.$row->pt_id);?>" class="btn btn-success btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php else:?>
                                                <td style="vertical-align: middle; color: white;"><a href="<?php echo site_url('admin/paten/edit/'.$row->pt_id);?>" class="btn btn-danger btn-block"><?php echo $row->namastatus;?></td></a>
                                                <?php endif;?>
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/paten/edit/'.$row->pt_id);?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
                                                    <!-- <a href="<?php echo site_url('admin/paten/view/'.$row->pt_id);?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-external-link-square"></span></a> -->
                                                    <!-- <a href="javascript:void(0);" class="btn btn-sm btn-secondary btn-circle btn-hapus" data-id="<?php echo $row->pt_id;?>"><span class="fa fa-trash"></span></a> -->
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                        </tbody>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/paten/hapus_paten'?>" method="post">
        ...
        <?php elseif($this->session->flashdata('msg')=='bates-input'):?>
            <script type="text/javascript">
                    $.toast({
                        heading: 'Warning',
                        text: "Kuota permohonan Paten anda sudah habis.",
                        showHideTransition: 'slide',
                        icon: 'success',
                        hideAfter: 4000,
                        position: 'bottom-right',
