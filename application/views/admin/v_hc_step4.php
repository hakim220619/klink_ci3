...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/hakcipta/update_hc4'?>" method="post" enctype="multipart/form-data" class="form-style">
            ...
            <div class="card-body"> <!-- div card-body -->
                ...
                <div class="row">
                        <div class="col-md-12 mt-3">
                            ...
                            <a href="<?php echo base_url()."admin/hakcipta/viewhc3/".$b['hc_id'];?>" class="btn btn-danger">Kembali</a>
