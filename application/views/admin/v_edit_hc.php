    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                <form action="<?php echo base_url().'admin/hakcipta/update_hc'?>" method="post" enctype="multipart/form-data">
                    <div class="row gutters-tiny invisible" data-toggle="appear">
                        <div class="col-md-8">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Edit Hak Cipta</h3>
                                </div>
                                <div class="block-content">
                                    
                                    <div class="form-group">
                                            <input type="text" name="xnama" value="<?php echo $b['hc_nama'];?>" class="form-control" placeholder="Nama" required>
                                    </div>
                                    <div class="form-group">
                                            <input type="text" name="xemail" value="<?php echo $b['hc_email'];?>" class="form-control" placeholder="Email" readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-addon position-absolute">
                                            ...
                                            <input type="tel" name="xnohp" value="<?php echo $b['hc_nohp'];?>" class="form-control" placeholder="No. Handphone" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                                    </div>
                                    </div>
                                   <div class="form-group">
                                         <?php if($this->session->userdata('akses')=='1'):?>
                                        <label class="control-label">Status:</label><br>
                                         <select name="hc_statusid" id="hc_statusid" class="form-control opt1hid" readonly>
                                     <option value="" disabled selected hidden>------------------------------- Status -------------------------------</option>
                                      <?php $status = $this->db->query("SELECT * FROM status ORDER BY status_nama ASC")->result(); ?>
                                        <?php foreach ($status as $pr) { ?>
                                        <?php if($b['hc_statusid'] == 0) { ?>
                                            <option value="<?php echo $pr->status_id; ?>"><?php echo $pr->status_nama; ?></option>
                                        <?php } else { ?>
                                            <option value="<?php echo $pr->status_id; ?>" <?php echo ($pr->status_id == $b['hc_statusid']) ? "selected" : ""; ?>>
                                      ...
                                      <?php }; ?>
                                        ...
                                        <label class="control-label" hidden>Status:</label><br>
                                         <select name="hc_statusid" id="hc_statusid" class="form-control opt1hid" hidden>
                                     <option value="" disabled selected hidden>------------------------------- Status -------------------------------</option>
                                      <?php $status = $this->db->query("SELECT * FROM status ORDER BY status_nama ASC")->result(); ?>
                                        <?php foreach ($status as $pr) { ?>
                                        <?php if($b['hc_statusid'] == 0) { ?>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="hc_ket" id="hc_ket" class="form-control" rows="4" maxlength="300"><?php echo $b['hc_ket']; ?></textarea>
                                            </div>
                                            <?php else:?>
                                            <div class="form-group">
                                                ...
                                                <textarea name="hc_ket" id="hc_ket" class="form-control" rows="4" maxlength="300" hidden><?php echo $b['hc_ket']; ?></textarea>
                                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <div class="form-group">
                                        <input type="file" name="filefoto" class="dropify2" data-height="230" data-default-file="<?php echo base_url().'assets/images/'.$b['hc_photo'];?>">
                                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('.dropify2').dropify({
                    messages: {
                        default: 'Gambar Berukuran 235 X 270 Pixels',
                        replace: 'Ganti',
                        remove:  'Hapus',
                        error:   'error'
                    }
