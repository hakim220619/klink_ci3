...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Step 1 - Desaind Ind</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
            ...
            <form action="<?php echo base_url().'admin/desainind/update_di1'?>" id="form" method="post" enctype="multipart/form-data" class="form-style">
...
<a href="<?php echo base_url()."admin/desainind/viewdi1/".$b['di_id'];?>" class="badge badge-primary badge-sm pull-right" style="width: 40px;margin-left: 2px !important;"> 1 </a>
...
<a href="<?php echo base_url()."admin/desainind/viewdi4/".$b['di_id'];?>" class="badge badge-danger badge-sm pull-right" style="width: 40px;margin-left: 2px !important;"> 4 </a>
            ...
            <div class="card-body"> <!-- div card-body -->
                <div class="row gutters-tiny invisible" data-toggle="appear"> <!-- div row -->
                    ...
                    <div class="col-md-6 pr-md-5 mt-10">
                        <div class="form-group">
                            ...
                            <input type="text" name="di_email" value="<?php echo $b['di_email'];?>" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Tanggal Pengajuan:</label>
                            <input type="text" name="tglaju" id="tglaju" value="<?php echo $b['di_tgl_pengajuan']; ?>" class="form-control" readonly>
                        </div>
			    ...
			    <small class="text-note"><i class="fa fa-info-circle"></i> Diisi oleh petugas.</small>
                            <?php else:?>
                            <input type="text" name="di_no_permohonan" id="di_no_permohonan" value="<?php echo $b['di_no_permohonan']; ?>" class="form-control" readonly>
			    <small class="text-note"><i class="fa fa-info-circle"></i> Diisi oleh petugas.</small>
                            <?php endif;?>
                        </div>
                    ...
                    <div class="col-md-6 pr-md-5 mt-10">
                        <div class="form-group">
                            ...
                            <input type="text" name="di_nama" value="<?php echo $b['di_nama'];?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label class="control-label">No. Handphone:</label>
                            <input type="tel" name="di_nohp" value="<?php echo $b['di_nohp'];?>" class="form-control" placeholder="Nomor Whatsapp Gunakan Awalan 62 contoh: 6287782728299" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2">
                                <div class="row form-group" id="di_photo">
                                 <div class="col-md-12">
                                     <input type="file" name="di_photo" value="<?php echo $b['di_photo']; ?>" id="di_photo" class="btn custom-input-file"><a href="<?php echo base_url().'assets/images/'.$b['di_photo'];?>"><?php echo $b['di_photo']; ?></a>
                                     </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            ...
                            <!-- <a href="<?php echo base_url()."admin/desainind/view/".$b['di_id'];?>" class="btn btn-danger btn-sm" style="width: 70px;">Kembali</a> -->
...
<!-----------------------------------------END FORM SECTION 1----------------------------------------->
    ...
    $(document).ready(function() {
        ...
        <script type="text/javascript">
        $(document).ready(function() {
            if($('#di_tgl_penerimaan').length) {
                var date = new Date();
                var today = new Date(date.getFullYear(), date.getMonth(), date.getDate());
                $('#di_tgl_penerimaan').datepicker({
                    format: "yyyy-mm-dd",
                    todayHighlight: true,
                    autoclose: true
                });
